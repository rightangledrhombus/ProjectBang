...
class TestVideos(unittest.TestCase):
    ...
    def test_find_screenshot_time(self):
        in_filename = in_filename = r"Z:\unittest\full_episode.mp4"
        screenshot = screenshot = r"Z:\unittest\s12_intro.jpg"
        search_start_time = 250
        search_duration = 90
        time = video_converter.find_screenshot_time(in_filename, screenshot, search_start_time=search_start_time, search_duration=search_duration)
    ...
    def test_video_container_convert(self):
        ...
        video_converter.convert_video_container(in_filename, out_container)
